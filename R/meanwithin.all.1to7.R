...
heatmap.2(as.matrix(a),Rowv=F,Colv=F,dendrogram="none",trace="none",labRow=medi.frame$odor,xlab="time (s)",ylab="odor",col=colorRampPalette(c("red","white","blue")),main="mean responses",symbreaks=T,key=T)
